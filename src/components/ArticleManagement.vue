      ...
      <div v-else class="flex-1 overflow-y-auto">
        <div class="space-y-3">
              <div
                  ...
                  class="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 dark:border-gray-700 hover:border-primary-200 dark:hover:border-primary-800"
              >
            <div class="flex items-start justify-between w-full">
              <div class="p-4 flex-1">
                <div class="flex items-center space-x-4">
                  <!-- Head Image -->
                  <div v-if="article.article_head_image" class="w-32 h-32 rounded-lg overflow-hidden flex-shrink-0 shadow-sm">
                    <img
                  ...
                  <div v-else
                       class="w-32 h-32 rounded-lg bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/30 dark:to-primary-800/30 flex items-center justify-center flex-shrink-0">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <span
                        ...
                        :key="tag.tag_id"
                        class="inline-flex items-center px-2 py-0.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-xs font-medium border border-gray-200 dark:border-gray-600"
                    >
